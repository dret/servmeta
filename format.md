...
* *Examples:* Specific information how to use the service based on examples, either simply based on API usage, or possibly based on specific client-side technologies.
